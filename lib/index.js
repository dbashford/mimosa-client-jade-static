"use strict";
var config, extensionRegex, fs, jade, logger, outputExtension, registration, __isJadeStatic, __outputFileName, _addStaticFilesToOutput, _pullStaticFilesOutAndCompile, _removeStaticJade;
...
registration = function(mimosaConfig, register) {
  var extensions, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
  extensions = ((_ref = mimosaConfig.compilers) != null ? (_ref1 = _ref.extensionOverrides) != null ? _ref1.jade : void 0 : void 0) || ["jade"];
  extensionRegex = (_ref2 = (_ref3 = mimosaConfig.clientJadeStatic) != null ? _ref3.extensionRegex : void 0) != null ? _ref2 : extensionRegex;
  outputExtension = (_ref4 = (_ref5 = mimosaConfig.clientJadeStatic) != null ? _ref5.outputExtension : void 0) != null ? _ref4 : outputExtension;
...
__outputFileName = function(mimosaConfig, inputFileName) {
  return inputFileName.replace(extensionRegex, outputExtension).replace(mimosaConfig.watch.sourceDir, mimosaConfig.watch.compiledDir);
};
